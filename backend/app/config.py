...
# Load test.env file from backend directory
env_path = Path(__file__).resolve().parents[1] / "test.env"
if env_path.exists():
    load_dotenv(dotenv_path=env_path)
    print(f"âœ… Environment loaded from: {env_path}")
else:
    print(f"âš ï¸  No test.env file found at: {env_path}")
...
class Settings:
    ...
    LEAD_NOTIFICATION_EMAIL: str = os.getenv("LEAD_NOTIFICATION_EMAIL", "janakbhat34@gmail.com")
